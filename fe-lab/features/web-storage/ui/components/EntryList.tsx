  ...
  return (
    <div>
      ...
      <div className="flex flex-col gap-1.5 max-h-[140px] overflow-y-auto">
        {entries.length === 0 ? (
          <div className="font-mono text-[11px] text-text-muted text-center py-4">
            비어 있음
          </div>
        ) : (
          entries.map((entry) => (
            ...
            >
              ...
              <button
                ...
                className="font-mono text-[10px] text-text-muted cursor-pointer bg-transparent border-none hover:text-accent-magenta transition-colors"
              >
                삭제
              </button>
            </div>
