...
export function FlexboxControls({
  ...
  const selectClass =
    "w-full font-[family-name:var(--font-mono)] text-[11px] bg-bg-deep text-text-primary border border-border-subtle rounded px-2 py-1.5";
  const labelClass =
    "font-[family-name:var(--font-mono)] text-[10px] text-text-muted block mb-1";
