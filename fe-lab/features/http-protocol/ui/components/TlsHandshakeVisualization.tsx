  ...
  return (
    <div className="flex gap-8">
      <div className="flex flex-col items-center gap-0 flex-1">
        <div className="font-mono text-[11px] text-accent-cyan font-semibold mb-3 px-3 py-1.5 rounded-lg bg-accent-cyan-dim border border-accent-cyan/30">
          Client
        </div>
      ...
      <div className="flex flex-col items-center gap-0 flex-1">
        <div className="font-mono text-[11px] text-accent-green font-semibold mb-3 px-3 py-1.5 rounded-lg bg-accent-green-dim border border-accent-green/30">
          Server
        </div>
