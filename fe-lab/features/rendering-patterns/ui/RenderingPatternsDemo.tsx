...
export default function RenderingPatternsDemo() {
  ...
  const rightPanel = (
    <>
      ...
      <div className="p-4 flex flex-col gap-3 font-mono text-label">
        {[
          ...
          <div key={row.label} className="flex flex-col gap-1">
            <span className="text-text-muted text-caption">{row.label}</span>
            <span
      ...
      <div className="mt-auto p-4 border-t border-border-subtle">
        ...
        <div className="font-mono text-label text-accent-amber leading-[1.6]">
          ...
          <div className="flex flex-col gap-2">
            {pattern.steps.map((step, i) => (
              <div key={i} className="flex items-center gap-3">
                <span
                  className="font-mono text-caption w-[120px] shrink-0 text-right"
          ...
          <div className="flex flex-col gap-1.5">
            {pattern.flow.map((step, i) => (
              <div key={i} className="flex items-start gap-2">
                <span className="font-mono text-caption text-accent-cyan shrink-0">
