...
export default function ServerComponentsPage() {
  return (
    <>
      <Topbar topicId="server-components" />

      <ConceptSection
        title="React Server Components"
        description="서버에서 렌더링되어 클라이언트 번들을 줄이는 새로운 컴포넌트 패러다임입니다."
      >
        <p className="text-sm text-text-secondary leading-[1.8]">
          ...
          수 없습니다. <InlineCode size="md">&quot;use client&quot;</InlineCode>
          로 Client Component를 선언하고,{" "}
      ...
      <DemoSection
        ...
        description="각 컴포넌트 유형의 렌더링 과정과 번들 사이즈 차이를 확인하세요."
      >
