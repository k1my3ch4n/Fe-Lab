...
export default function HttpCachePage() {
  return (
    <>
      <Topbar topicId="http-cache" />

      <ConceptSection
        title="HTTP 캐시 전략"
        description="HTTP 캐시는 네트워크 요청을 줄이고 웹 성능을 극대화하는 핵심 메커니즘입니다. 올바른 캐시 전략은 사용자 경험과 서버 부하 모두에 큰 영향을 미칩니다."
      >
      ...
      <DemoSection
        title="캐시 시나리오 시뮬레이션"
        description="각 캐시 전략의 요청-응답 흐름을 단계별로 확인하세요. 브라우저, 캐시, 서버 간의 HTTP 헤더 교환을 시각적으로 이해할 수 있습니다."
      >
        <HttpCacheDemo />
      </DemoSection>
