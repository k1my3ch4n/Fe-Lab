...
export default function IntersectionObserverPage() {
  return (
    <>
      <Topbar topicId="intersection-observer" />

      <ConceptSection
        title="Intersection Observer"
        description="Intersection Observer는 요소가 뷰포트 또는 특정 부모 요소와 교차하는 것을 비동기적으로 감지하는 Web API입니다."
      >
      ...
      <DemoSection
        ...
        description="스크롤하며 요소의 뷰포트 진입/이탈을 실시간으로 확인하세요. threshold를 조절해보세요."
      >
