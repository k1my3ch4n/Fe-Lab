...
export default function CurryingCompositionPage() {
  return (
    <>
      <Topbar topicId="currying-composition" />

      <ConceptSection
        title="커링과 함수 합성"
        description="커링은 다중 인자 함수를 단일 인자 함수 체인으로 변환하고, 함수 합성은 여러 함수를 결합하여 새로운 함수를 만듭니다."
      >
      ...
      <DemoSection
        ...
        description="각 예제를 선택하고 단계별로 실행하여 커링과 합성 과정을 확인하세요."
      >
        <CurryingCompositionDemo />
      </DemoSection>
