...
export default function WebAccessibilityPage() {
  return (
    <>
      <Topbar topicId="web-accessibility" />

      <ConceptSection
        title="웹 접근성 (Web Accessibility)"
        description="웹 접근성은 모든 사용자가 장애 여부와 관계없이 웹 콘텐츠를 동등하게 이용할 수 있도록 보장하는 것입니다."
      >
      ...
      <DemoSection
        title="접근성 시각화"
        description="시맨틱 HTML vs div 비교, ARIA 속성 적용, 키보드 네비게이션을 테스트하세요."
      >
        <WebAccessibilityDemo />
      </DemoSection>
