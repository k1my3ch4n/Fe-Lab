...
export default function StateManagementPage() {
  return (
    <>
      <Topbar topicId="state-management" />

      <ConceptSection
        title="상태 관리 패턴"
        description="React 앱에서 전역 상태를 효율적으로 관리하는 다양한 패턴과 라이브러리를 비교합니다."
      >
      ...
      <DemoSection
        title="상태 관리 패턴 비교"
        description="각 접근법의 아키텍처를 비교하고, prop drilling 문제를 시각적으로 확인하세요."
      >
        <StateManagementDemo />
      </DemoSection>
