...
import { XssCsrfDemo } from "@features/xss-csrf";
import { codeExamples, interviewQuestions } from "@features/xss-csrf/data";

export default function XssCsrfPage() {
  return (
    <>
      <Topbar topicId="xss-csrf" />

      <ConceptSection
        title="XSS / CSRF 방지"
        description="웹 애플리케이션의 가장 흔한 두 가지 보안 취약점과 방어 전략을 학습합니다."
      >
      ...
      <DemoSection
        title="보안 공격 / 방어 시각화"
        description="XSS, CSRF 공격 흐름을 시뮬레이션하고, 방어 전략을 확인하세요."
      >
        <XssCsrfDemo />
      </DemoSection>
