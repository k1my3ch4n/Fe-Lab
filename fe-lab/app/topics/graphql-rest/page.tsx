...
export default function GraphqlRestPage() {
  return (
    <>
      <Topbar topicId="graphql-rest" />

      <ConceptSection
        title="GraphQL vs REST"
        description="REST와 GraphQL은 API를 설계하는 두 가지 주요 패러다임입니다. 각각의 장단점과 적합한 사용 사례를 이해해야 합니다."
      >
      ...
      <DemoSection
        ...
        description="Over-fetching, Under-fetching 문제를 시각적으로 비교하세요."
      >
        <GraphqlRestDemo />
      </DemoSection>
