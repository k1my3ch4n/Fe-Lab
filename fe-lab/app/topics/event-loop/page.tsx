      ...
      concept={{
        ...
        children: (
          <p className="text-sm text-text-secondary leading-[1.8]">
            ...
            통해 비동기 작업을 효율적으로 처리합니다. 콜 스택이 비면 이벤트
            루프가 <InlineCode size="md">마이크로태스크 큐</InlineCode>를 먼저
            확인하고, 그 다음 <InlineCode size="md">태스크 큐</InlineCode>에서
            작업을 꺼내 실행합니다.{" "}
            <InlineCode size="md">Promise.then</InlineCode>과{" "}
