...
import { VirtualDomDemo } from "@features/virtual-dom";
import { codeExamples, interviewQuestions } from "@features/virtual-dom/data";

export default function VirtualDomPage() {
  return (
    <>
      <Topbar topicId="virtual-dom" />

      <ConceptSection
        title="Virtual DOM"
        description="Virtual DOM은 실제 DOM의 가벼운 JavaScript 객체 표현으로, 효율적인 UI 업데이트를 가능하게 합니다."
      >
      ...
      <DemoSection
        ...
        description="단계별로 진행하며 Virtual DOM이 어떻게 변경 사항을 감지하고 최소한의 DOM 조작으로 업데이트하는지 확인하세요."
      >
        <VirtualDomDemo />
      </DemoSection>
