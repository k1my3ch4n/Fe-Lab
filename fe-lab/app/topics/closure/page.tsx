...
import { ClosureDemo } from "@features/closure";
import { codeExamples, interviewQuestions } from "@features/closure/data";

export default function ClosurePage() {
  return (
    <>
      <Topbar topicId="closure" />

      <ConceptSection
        title="클로저 (Closure)"
        description="클로저는 함수와 그 함수가 선언된 렉시컬 환경의 조합입니다. 내부 함수가 외부 함수의 변수를 기억하는 현상입니다."
      >
      ...
      <DemoSection
        ...
        description="각 예제를 선택하고 실행하여 클로저가 어떻게 외부 변수를 기억하는지 확인하세요."
      >
        <ClosureDemo />
      </DemoSection>
