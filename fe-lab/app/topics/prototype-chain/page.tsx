...
export default function PrototypeChainPage() {
  return (
    <>
      <Topbar topicId="prototype-chain" />

      <ConceptSection
        title="프로토타입 체인 (Prototype Chain)"
        description="JavaScript는 프로토타입 기반 언어입니다. 객체의 프로퍼티를 찾을 때 프로토타입 체인을 따라 탐색합니다."
      >
      ...
      <DemoSection
        ...
        description="객체를 선택하고 프로퍼티를 입력하면, 체인을 따라 탐색하는 과정을 확인할 수 있습니다."
      >
        <PrototypeChainDemo />
      </DemoSection>
