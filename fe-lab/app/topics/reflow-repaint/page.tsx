...
export default function ReflowRepaintPage() {
  return (
    <>
      <Topbar topicId="reflow-repaint" />

      <ConceptSection
        title="리플로우와 리페인트 (Reflow & Repaint)"
        description="브라우저가 CSS 변경 시 어떤 렌더링 단계를 다시 실행하는지 이해하면 성능 최적화의 핵심을 파악할 수 있습니다."
      >
      ...
      <DemoSection
        ...
        description="CSS 속성을 선택하면 어떤 렌더링 단계가 실행되는지 확인할 수 있습니다."
      >
        <ReflowRepaintDemo />
      </DemoSection>
