...
export default function WebStoragePage() {
  return (
    <>
      <Topbar topicId="web-storage" />

      <ConceptSection
        title="Web Storage"
        description="Web Storage API는 브라우저에 키-값 쌍을 저장하는 메커니즘을 제공합니다. localStorage, sessionStorage, IndexedDB를 비교합니다."
      >
      ...
      <DemoSection
        ...
        description="각 스토리지에 데이터를 저장, 조회, 삭제하며 동작 차이를 확인하세요."
      >
        <WebStorageDemo />
      </DemoSection>
