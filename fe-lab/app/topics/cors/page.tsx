...
import { CorsDemo } from "@features/cors";
  ...
  return (
    <>
      ...
      <ConceptSection
        ...
        description="CORS는 브라우저의 동일 출처 정책을 제어하여 다른 출처의 리소스 접근을 허용하는 HTTP 헤더 기반 메커니즘입니다."
      >
      ...
      <DemoSection
        ...
        description="각 시나리오를 선택하고 단계별로 재생하여 브라우저와 서버 간의 CORS 헤더 교환 과정을 확인하세요."
      >
        <CorsDemo />
      </DemoSection>
