...
export default function RenderingPatternsPage() {
  return (
    <>
      <Topbar topicId="rendering-patterns" />

      <ConceptSection
        title="CSR / SSR / ISR / SSG"
        description="웹 페이지를 렌더링하는 4가지 방식을 비교합니다. 각 방식은 렌더링 시점과 장소가 다르며, 성능과 SEO에 큰 영향을 미칩니다."
      >
      ...
      <DemoSection
        ...
        description="각 방식의 서버 처리, HTML 전송, JS 실행, 화면 표시 시점을 비교하세요."
      >
        <RenderingPatternsDemo />
      </DemoSection>
