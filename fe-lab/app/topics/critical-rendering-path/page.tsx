...
export default function CriticalRenderingPathPage() {
  return (
    <>
      <Topbar topicId="critical-rendering-path" />

      <ConceptSection
        title="크리티컬 렌더링 패스 (Critical Rendering Path)"
        description="브라우저가 HTML, CSS, JS를 받아 화면에 첫 픽셀을 그리기까지의 과정을 이해하고 최적화하는 방법을 학습합니다."
      >
      ...
      <DemoSection
        ...
        description="각 최적화 전략을 선택하여 리소스 로딩 타임라인과 FCP가 어떻게 변하는지 비교하세요."
      >
